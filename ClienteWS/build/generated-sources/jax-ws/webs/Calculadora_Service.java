 ...
 * 
 */
@WebServiceClient(name = "Calculadora", targetNamespace = "http://webs/", wsdlLocation = "http://localhost:8080/CalculadoraWS/Calculadora?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORA_QNAME = new QName("http://webs/", "Calculadora");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculadoraWS/Calculadora?WSDL");
    ...
    public Calculadora getCalculadoraPort() {
        return super.getPort(new QName("http://webs/", "CalculadoraPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webs/", "CalculadoraPort"), Calculadora.class, features);
    }
