...
public class ObjectFactory {
    ...
    private final static QName _SomarResponse_QNAME = new QName("http://webs/", "somarResponse");
    private final static QName _MultiplicarResponse_QNAME = new QName("http://webs/", "multiplicarResponse");
    private final static QName _Somar_QNAME = new QName("http://webs/", "somar");
    private final static QName _Dividir_QNAME = new QName("http://webs/", "dividir");
    private final static QName _DividirResponse_QNAME = new QName("http://webs/", "dividirResponse");
    private final static QName _Multiplicar_QNAME = new QName("http://webs/", "multiplicar");
    private final static QName _Subtrair_QNAME = new QName("http://webs/", "subtrair");
    private final static QName _SubtrairResponse_QNAME = new QName("http://webs/", "subtrairResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "somarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "somar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "subtrair")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webs/", name = "subtrairResponse")
